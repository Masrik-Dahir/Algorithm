...
public class MinSparseTable {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(sparseTable.queryMin(1, 5));
    System.out.println(sparseTable.queryMinIndex(1, 5));

    System.out.println(sparseTable.queryMin(3, 3));
    System.out.println(sparseTable.queryMinIndex(3, 3));

    System.out.println(sparseTable.queryMin(3, 6));
    System.out.println(sparseTable.queryMinIndex(3, 6));
  }
